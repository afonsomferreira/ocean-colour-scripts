...
os.chdir('C:\\Users\\afons\\OneDrive - Universidade de Lisboa\\Documents\\PhD\\OPERANTARXLII\\imagens_sat\\raw_modis')
#%% Part 1 - Load MODIS .nc image
file_path = 'AQUA_MODIS.20240227.L3m.DAY.CHL.chlor_a.4km.NRT.nc'
...
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\OneDrive - Universidade de Lisboa\\Documents\\PhD\\OPERANTARXLII\\imagens_sat\\MODIS_27Fev2024.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
#%% Repeat for other image
file_path = 'AQUA_MODIS.20240126.L3m.DAY.CHL.chlor_a.4km.NRT.nc'
# Load the NetCDF file using xarray
ds = xr.open_dataset(file_path)
# Access the variables
chl = np.array(ds['chlor_a'])
...
#                                        facecolor=cartopy.feature.COLORS['land']))
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Downloads\\rafa_operantar2024\\modis\\AQUA_MODIS.20240126.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
#%% Repeat for other image
file_path = 'AQUA_MODIS.20240127.L3m.DAY.CHL.chlor_a.4km.NRT.nc'
# Load the NetCDF file using xarray
ds = xr.open_dataset(file_path)
# Access the variables
chl = np.array(ds['chlor_a'])
...
#                                        facecolor=cartopy.feature.COLORS['land']))
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Downloads\\rafa_operantar2024\\modis\\AQUA_MODIS.20240127.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
#%% Repeat for other image
file_path = 'AQUA_MODIS.20240128.L3m.DAY.CHL.chlor_a.4km.NRT.nc'
# Load the NetCDF file using xarray
ds = xr.open_dataset(file_path)
# Access the variables
chl = np.array(ds['chlor_a'])
...
#                                        facecolor=cartopy.feature.COLORS['land']))
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Downloads\\rafa_operantar2024\\modis\\AQUA_MODIS.20240128.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
