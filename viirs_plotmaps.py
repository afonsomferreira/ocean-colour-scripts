...
os.chdir('C:\\Users\\afons\\Downloads\\rafa_operantar2024\\viirs\\')
#%% Part 1 - Load MODIS .nc image
file_path = 'SNPP_VIIRS.20240101_20240108.L3m.8D.CHL.chlor_a.4km.NRT.nc'
...
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Downloads\\rafa_operantar2024\\viirs\\SNPP_VIIRS.20240101_20240108.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
#%% Repeat for other image
file_path = 'SNPP_VIIRS.20240109_20240116.L3m.8D.CHL.chlor_a.4km.NRT.nc'
# Load the NetCDF file using xarray
ds = xr.open_dataset(file_path)
# Access the variables
chl = np.array(ds['chlor_a'])
...
#                                        facecolor=cartopy.feature.COLORS['land']))
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Downloads\\rafa_operantar2024\\viirs\\SNPP_VIIRS.20240109_20240116.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
#%% Repeat for other image
file_path = 'SNPP_VIIRS.20240117_20240124.L3m.8D.CHL.chlor_a.4km.NRT.nc'
# Load the NetCDF file using xarray
ds = xr.open_dataset(file_path)
# Access the variables
chl = np.array(ds['chlor_a'])
...
#                                        facecolor=cartopy.feature.COLORS['land']))
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Downloads\\rafa_operantar2024\\viirs\\SNPP_VIIRS.20240117_20240124.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
#%%
# Change to your working directory where datafiles and scripts are stored
os.chdir('C:\\Users\\afons\\Downloads\\rafa_operantar2024\\viirs_jpss\\')
#%% Part 1 - Load MODIS .nc image
file_path = 'JPSS1_VIIRS.20240101_20240108.L3m.8D.CHL.chlor_a.4km.NRT.nc'
# Load the NetCDF file using xarray
ds = xr.open_dataset(file_path)
# Access the variables
chl = np.array(ds['chlor_a'])
...
#                                        facecolor=cartopy.feature.COLORS['land']))
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Downloads\\rafa_operantar2024\\viirs_jpss\\JPSS1_VIIRS.20240101_20240108.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
#%% Repeat for other image
file_path = 'JPSS1_VIIRS.20240109_20240116.L3m.8D.CHL.chlor_a.4km.NRT.nc'
# Load the NetCDF file using xarray
ds = xr.open_dataset(file_path)
# Access the variables
chl = np.array(ds['chlor_a'])
...
#                                        facecolor=cartopy.feature.COLORS['land']))
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Downloads\\rafa_operantar2024\\viirs_jpss\\JPSS1_VIIRS.20240109_20240116.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
#%% Repeat for other image
file_path = 'JPSS1_VIIRS.20240117_20240124.L3m.8D.CHL.chlor_a.4km.NRT.nc'
# Load the NetCDF file using xarray
ds = xr.open_dataset(file_path)
# Access the variables
chl = np.array(ds['chlor_a'])
...
#                                        facecolor=cartopy.feature.COLORS['land']))
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Downloads\\rafa_operantar2024\\viirs_jpss\\JPSS1_VIIRS.20240117_20240124.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()